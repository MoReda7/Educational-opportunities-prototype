...
export const TRANSLATIONS: Record<Language, {
  ...
  en: {
    ...
    hero: {
      ...
      description: 'Discover courses, scholarships, internships, and other opportunities in one place.',
    ...
    categories: {
      ...
      subtitle: 'Browse curated programs tailored to your academic and professional goals',
      Courses: 'Courses',
    ...
    explore: {
      ...
      all: 'All',
      foundCount: 'opportunities found',
  ...
  ar: {
    ...
    hero: {
      ...
      description: 'اكتشف الدورات، والمنح الدراسية، والتدريب العملي، والفرص الأخرى في مكان واحد.',
    ...
    categories: {
      title: 'استكشف الفئات',
      subtitle: 'تصفح برامج مختارة مصممة لتناسب أهدافك الأكاديمية والمهنية',
      Courses: 'دورات',
    ...
    explore: {
      title: 'استكشف الفرص',
      subtitle: 'تصفح وتصفية الفرص الأكاديمية والمهنية العالمية',
      searchPlaceholder: 'ابحث حسب العنوان، المؤسسة، الموضوع، الدولة...',
      filterTitle: 'تصفية الفرص',
      ...
      all: 'الكل',
      foundCount: 'فرص تعليمية تم العثور عليها',
