          ...
          <nav className="flex items-center gap-1">
            ...
            {savedCount > 0 && (
              <button
                ...
                title={`${savedCount} saved opportunities`}
              >
                <Bookmark className="w-4 h-4 text-primary-main fill-primary-main/20" />
                <span className="text-xs bg-primary-light text-primary-dark font-bold px-1.5 py-0.5 rounded-full">
                  {savedCount}
                </span>
              </button>
            )}
